...
// forge script script/RegisterProtocolBaseActorsAndReportRanks.sol:RegisterProtocolBaseActorsAndReportRanks --sig "enterAgreement(address)" 0x6D544390Eb535d61e196c87d6B9c80dCD8628Acd --rpc-url 127.0.0.1:8545 --broadcast

// forge script script/RegisterProtocolBaseActorsAndReportRanks.sol:RegisterProtocolBaseActorsAndReportRanks --chain 11155420 --rpc-url $OP_SEPOLIA_RPC_URL --broadcast
// forge script script/RegisterProtocolBaseActorsAndReportRanks.sol:RegisterProtocolBaseActorsAndReportRanks --chain 11155420 --rpc-url $OP_SEPOLIA_RPC_URL --sig "enterAgreement(address)" 0x4a678e4BBD17ae2b89FcB273fA1364F0e93Fc0C9 --broadcast
...
contract RegisterProtocolBaseActorsAndReportRanks is Script {
    ...
    uint256 ptoPrivKey = vm.envUint("PRIV_KEY_PTO_EOP");
    address ptoAddr = vm.addr(ptoPrivKey);
    uint256 prov1PrivKey = vm.envUint("PRIV_KEY_PROV1_EOP");
    address prov1Addr = vm.addr(prov1PrivKey);
    uint256 prov2PrivKey = vm.envUint("PRIV_KEY_PROV2_EOP");
    address prov2Addr = vm.addr(prov2PrivKey);
    uint256 val1PrivKey = vm.envUint("PRIV_KEY_VAL1_EOP");
    address val1Addr = vm.addr(val1PrivKey);
    uint256 user1PrivKey = vm.envUint("PRIV_KEY_USER1_EOP");
    address user1Addr = vm.addr(user1PrivKey);
    
    string public PTO_DETAILS_LINK = vm.envString("PTO_DETAILS_LINK_EOP");
    string public PROV_DETAILS_LINK = vm.envString("PROV1_DETAILS_LINK_EOP");
    string public OFFER_DETAILS_LINK = vm.envString("OFFER_DETAILS_LINK_EOP");
    string public PC_DETAILS_LINK = vm.envString("PT_DETAILS_LINK_EOP");
    string public VAL_DETAILS_LINK = vm.envString("VAL1_DETAILS_LINK_EOP");
